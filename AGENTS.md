...
- Do not run automatic tests or verification unless the user explicitly asks. This includes unit, integration, and e2e tests; browser or demo click-throughs; `npm run check`; `cargo test`; and skill-prescribed build/test loops.
